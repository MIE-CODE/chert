...
export default function LoginPage() {
  ...
  const handleSubmit = async (values: { email: string; password: string }) => {
    try {
      ...
      // Error is handled by useAuth hook and shown as toast
    }
  };

  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-primary-light to-background p-4 safe-area-inset">
      <div className="w-full max-w-md">
        <div className="mb-6 md:mb-8 text-center">
          <h1 className="text-2xl md:text-3xl font-bold text-primary mb-2">Welcome back</h1>
          <p className="text-sm md:text-base text-secondary">Sign in to continue to Chert</p>
        </div>

        <div className="bg-surface-elevated rounded-2xl shadow-xl p-6 md:p-8 border border-border">
          <Formik
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <Link
                    ...
                    className="text-sm text-primary hover:text-primary-hover mt-2 block text-right"
                  >
                    Forgot password?
                  </Link>
                </div>
